  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Built scalable and maintainable automation framework using Java and Selenium, resulting in improved test coverage and faster regression testing}
        \resumeItem{Containerized test automation scripts, and designed Jenkins pipeline to run tests in parallel}
        \resumeItem{Conducted API testing using tools like Postman, and Rest Assured, ensuring proper functioning and data consistency}
...
\section{SKILLS}
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
     ...
     \textbf{Tools and Framework}{: Selenium, Playwright, TestNG, Gradle, Rest assured, Postman, Git, NPM, and Jira}
