  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Architected a scalable and maintainable automation framework using Typescript and Cypress, enhancing test coverage and expediting regression testing}
        \resumeItem{Containerized test automation scripts and devised a Jenkins pipeline for parallel test execution}
        \resumeItem{Conducted API testing employing tools such as Postman, SuperTest and Mocha, validating functionality and data integrity}
        ...
        \resumeItem{Successfully integrated Cypress tests into React application's CI/CD pipelines, collaborating with development teams to ensure automated testing on each code change}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Actively participated in daily stand-ups, sprint planning, and collaborative sessions to streamline communication}
...
\section{SKILLS}
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
     ...
     \textbf{Tools and Framework}{: Selenium, Cypress, Playwright, WebDriverIO, Mocha, Rest assured, Postman, Git, and Jira}
